// module.exports = class QuestSelection : Export node.js version
module.exports = class QuestSelection {
    constructor(actNum, questNum) {
        this.actNum = actNum
    ...
    nextQuest() {
        if (this.questNum < this.questList[this.actNum].length - 1) {
            this.questNum++
        }
    }
    ...
    getQuest() {
        return this.questList[this.actNum][this.questNum]
    }
}